...
mutable struct feMesh
    ...
    function feMesh(mesh::Mesh, boundaryCondition::Base.Function)
        ...
        boundary_nodes,
            internal_nodes = find_node_number(
            n_nodes, n_bc_nodes,
        ...
        return new(
            n_nodes, n_elements, nodes, internal_nodes, boundary_nodes, elements,
...
function find_node_number(
        n_nodes, n_bc_nodes, external_nodes, nodes,
